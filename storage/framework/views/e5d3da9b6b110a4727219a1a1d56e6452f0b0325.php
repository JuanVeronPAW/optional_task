        ...
        <?php echo method_field('PUT'); ?>
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Brand:</strong>
                    <input type="text" name="brand" value="<?php echo e($item->brand); ?>" class="form-control" placeholder="Brand">
                </div>
            </div>
...
<?php echo $__env->make('items.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LAMAR KERJA\Dokumen\PT Sinar Metrindo Perkasa\technical-test-main\resources\views/items/edit.blade.php ENDPATH**/ ?>